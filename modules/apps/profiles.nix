{ __findFile, ... }: {
  my.profiles._ = {
    ...
    gaming.provides = {
      ...
      emulators.includes = [ <my/apps/emulators> ];
    ...
    art.provides = {
      ...
      modelling.includes = [ <my/apps/art/blender> ];
      drawing.includes = [ <my/apps/art/aseprite> ];
    };
    ...
    theming.includes = [ <my/apps/stylix> ];
